/** @file create a pdf from scratch with the list of possible measures and documents and the answers from the chat bot */

/** uuencoded wir-bleiben-liqui.de logo */
...
/** depending on the answers select the entity to help with measure or document */
function who_does(what) {
    if (answers["wer_macht_was_"+what]=="Ein anderer Dienstleister") {
        return answers[what+"_extern"];
    } else if (answers["wer_macht_was_"+what]=="Dein Steuerberater") {
...
/** create the text of the document from answers */
...
/** main function: create a pdf with logo and (a lot of) text, download it */
